...
> **Related skills:** For spawning entities within prefabs, see `docs/hytale-api/spawning-entities.md`. For world generation with prefabs, see `docs/hytale-api/world-gen.md`.
