...
> **Related skills:** For Codec/BuilderCodec serialization details, see `docs/hytale-api/persistent-data.md`. For entity effects using ECS, see `docs/hytale-api/entity-effects.md`.
...
public class PoisonComponent implements Component<EntityStore> {
    ...
    // BuilderCodec for serialization (see docs/hytale-api/persistent-data.md for full Codec reference)
...
> **Important:** KeyedCodec identifier strings must be **Uppercase** and **globally unique across your entire mod**. See `docs/hytale-api/persistent-data.md` skill for full Codec reference including validators, MapCodec, and complex types.
