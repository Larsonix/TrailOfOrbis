...
- **Instance teleportation**: For teleporting into instanced worlds, see the `docs/hytale-api/instances.md` skill which provides higher-level APIs via `InstancesPlugin`.
