...
> **Related skills:** For persistent data/Codec patterns, see `docs/hytale-api/persistent-data.md`. For ECS fundamentals, see `docs/hytale-api/ecs.md`. For inventory management, see the Hytale inventory APIs. For entity effects applied by items, see `docs/hytale-api/entity-effects.md`.
...
> **See also:** `docs/hytale-api/persistent-data.md` skill for full Codec/BuilderCodec/KeyedCodec reference.
