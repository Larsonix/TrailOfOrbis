...
>
> **Related skills:** `docs/hytale-api/events.md` (general event system), `docs/hytale-api/ecs.md` (ECS fundamentals), `docs/hytale-api/entity-effects.md` (effects/damage pipeline).
