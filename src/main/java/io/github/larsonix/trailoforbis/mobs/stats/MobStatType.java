...
public enum MobStatType {
    ...
    ATTACK_SPEED("attackSpeed", "Attack Speed", MobStatType.Category.MOVEMENT, 1.0, 0.5, 2.5, 0.0),       // DEAD: AI stat, never stored
    ATTACK_RANGE("attackRange", "Attack Range", MobStatType.Category.MOVEMENT, 2.0, 1.0, 20.0, 0.0),       // DEAD: AI stat, never stored
    ATTACK_COOLDOWN("attackCooldown", "Attack Cooldown", MobStatType.Category.MOVEMENT, 1.0, 0.1, 3.0, 0.0), // DEAD: AI stat, never stored
    ...
    BLOCK_CHANCE("blockChance", "Block Chance", MobStatType.Category.DEFENSE, 0.0, 0.0, 40.0, 0.0),   // DEAD: passive block removed in v1.0.2
    PARRY_CHANCE("parryChance", "Parry Chance", MobStatType.Category.DEFENSE, 0.0, 0.0, 30.0, 0.0), // DEAD: no parry handler for mobs
    ...
    // DEAD: Elemental % damage stats — pipeline skips these for mobs (isMobStats() check)
    FIRE_INCREASED_DAMAGE("fireIncreasedDamage", "Fire Increased Damage", MobStatType.Category.ELEMENTAL_INCREASED_DAMAGE, 0.0, 0.0, 200.0, 0.0),
    WATER_INCREASED_DAMAGE("waterIncreasedDamage", "Water Increased Damage", MobStatType.Category.ELEMENTAL_INCREASED_DAMAGE, 0.0, 0.0, 200.0, 0.0),
    LIGHTNING_INCREASED_DAMAGE("lightningIncreasedDamage", "Lightning Increased Damage", MobStatType.Category.ELEMENTAL_INCREASED_DAMAGE, 0.0, 0.0, 200.0, 0.0),
    EARTH_INCREASED_DAMAGE("earthIncreasedDamage", "Earth Increased Damage", MobStatType.Category.ELEMENTAL_INCREASED_DAMAGE, 0.0, 0.0, 200.0, 0.0),
    WIND_INCREASED_DAMAGE("windIncreasedDamage", "Wind Increased Damage", MobStatType.Category.ELEMENTAL_INCREASED_DAMAGE, 0.0, 0.0, 200.0, 0.0),
    VOID_INCREASED_DAMAGE("voidIncreasedDamage", "Void Increased Damage", MobStatType.Category.ELEMENTAL_INCREASED_DAMAGE, 0.0, 0.0, 200.0, 0.0),
    FIRE_MORE_DAMAGE("fireMoreDamage", "Fire More Damage", MobStatType.Category.ELEMENTAL_MORE_DAMAGE, 0.0, 0.0, 100.0, 0.0),
    WATER_MORE_DAMAGE("waterMoreDamage", "Water More Damage", MobStatType.Category.ELEMENTAL_MORE_DAMAGE, 0.0, 0.0, 100.0, 0.0),
    LIGHTNING_MORE_DAMAGE("lightningMoreDamage", "Lightning More Damage", MobStatType.Category.ELEMENTAL_MORE_DAMAGE, 0.0, 0.0, 100.0, 0.0),
    EARTH_MORE_DAMAGE("earthMoreDamage", "Earth More Damage", MobStatType.Category.ELEMENTAL_MORE_DAMAGE, 0.0, 0.0, 100.0, 0.0),
    WIND_MORE_DAMAGE("windMoreDamage", "Wind More Damage", MobStatType.Category.ELEMENTAL_MORE_DAMAGE, 0.0, 0.0, 100.0, 0.0),
    VOID_MORE_DAMAGE("voidMoreDamage", "Void More Damage", MobStatType.Category.ELEMENTAL_MORE_DAMAGE, 0.0, 0.0, 100.0, 0.0),
    // DEAD: AI stats — never stored in MobStats, never used in combat
    AGGRO_RANGE("aggroRange", "Aggro Range", MobStatType.Category.AI, 16.0, 8.0, 64.0, 0.0),
    REACTION_DELAY("reactionDelay", "Reaction Delay", MobStatType.Category.AI, 1.0, 0.1, 2.0, 0.0),
    CHARGE_TIME("chargeTime", "Charge Time", MobStatType.Category.AI, 1.0, 0.2, 3.0, 0.0),
    CHARGE_DISTANCE("chargeDistance", "Charge Distance", MobStatType.Category.AI, 5.0, 2.0, 20.0, 0.0),
