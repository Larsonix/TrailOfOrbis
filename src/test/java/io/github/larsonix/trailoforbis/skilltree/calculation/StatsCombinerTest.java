...
public class StatsCombinerTest {
    ...
    class PipelineCoverageTests {
        ...
        @EnumSource(value = StatType.class, mode = EnumSource.Mode.EXCLUDE, names = {
            ...
            // these are read by CombatEffect implementations, not the stat pipeline)
            "AILMENT_RESISTANCE_PER_TYPE", "ALL_ELEMENTAL_RESISTANCE", "ARMOR_TO_THORNS_PERCENT",
            "ATK_SPEED_CONVERSION_THRESHOLD", "ATTACK_SELF_DAMAGE_PERCENT", "BLOCK_CHARGE_COUNT",
            "BLOCK_CHARGE_LIFE_STEAL", "BLOCK_CHARGE_TEMP_HP", "BLOCK_ES_REGEN_UNINTERRUPTED",
            "BLOCK_SHOOT_DAMAGE_PENALTY", "BLOCK_SHOOT_ENABLED", "BULWARK_ARMOR_PER_HIT",
            "BULWARK_MAX_STACKS", "BURN_LEECH_PERCENT", "CHARGED_PROJECTILE_FIRE_BONUS",
            "CRIT_SHOCK_CHANCE", "DOT_LEECH_PERCENT", "EVADE_CRIT_MULT_BONUS",
            "EVADE_GUARANTEED_CRIT", "EVADE_HP_RESTORE_PERCENT", "FIRE_DAMAGE_VS_SHOCKED",
            "FOCUSED_SHOT_CHARGE_TIME", "FOCUSED_SHOT_DAMAGE_BONUS", "FOCUSED_SHOT_RESIST_IGNORE",
            "FORTIFIED_ARMOR_BONUS", "FORTIFIED_BLOCK_BONUS", "FORTIFIED_BLOCK_HEAL",
            "FREEZE_COOLDOWN", "FREEZE_SHATTER_MULTIPLIER", "HEALTH_REGEN_DISABLED",
            "LIFE_STEAL_HP_CAP_PERCENT", "LIFE_STEAL_REDUCTION", "MISSING_HP_DAMAGE_SCALING",
            "NON_FROZEN_DAMAGE_PENALTY", "NON_SPELL_DAMAGE_PENALTY", "OVERKILL_CHARGE_ENABLED",
            "PROJECTILE_ATTACK_SPEED_BONUS", "PROJECTILE_FREEZE_CHANCE", "PROJECTILE_SPELL_DAMAGE_BONUS",
            "RAMPAGE_DURATION", "RAMPAGE_MAX_STACKS", "RAMPAGE_STACK_ATK_SPEED",
            "RAMPAGE_STACK_CRIT_MULT", "RAMPAGE_STACK_DOT", "SHOCK_CHAIN_COUNT",
            "SHOCK_CHAIN_STRENGTH", "SHOCK_VOID_DAMAGE_BONUS", "SINGLE_TARGET_DAMAGE_PERCENT",
            "SPELL_CRIT_HEAL_PERCENT", "SPELL_CRIT_VS_FROZEN_LIGHTNING_BONUS",
            "SPELL_KILL_MANA_RESTORE", "VOID_DAMAGE_VS_FROZEN", "VOID_TO_TRUE_DAMAGE_PERCENT"
        })
